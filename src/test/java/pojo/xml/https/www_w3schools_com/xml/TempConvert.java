package pojo.xml.https.www_w3schools_com.xml;
 ...
 * 2022-06-17T09:39:13.185+03:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "TempConvert",
                  wsdlLocation = "file:///C:/Users/yuri.nechunaev/YandexDisk/tempconvert.xml",
...
public class TempConvert extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:///C:/Users/yuri.nechunaev/YandexDisk/tempconvert.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TempConvert.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:///C:/Users/yuri.nechunaev/YandexDisk/tempconvert.xml");
        }
        WSDL_LOCATION = url;
    }
    ...
    public https.www_w3schools_com.xml.TempConvertHttpPost getTempConvertHttpPost() {
        return super.getPort(TempConvertHttpPost, https.www_w3schools_com.xml.TempConvertHttpPost.class);
    }
     ...
     */
    @WebEndpoint(name = "TempConvertHttpPost")
    public https.www_w3schools_com.xml.TempConvertHttpPost getTempConvertHttpPost(WebServiceFeature... features) {
        return super.getPort(TempConvertHttpPost, https.www_w3schools_com.xml.TempConvertHttpPost.class, features);
    }
